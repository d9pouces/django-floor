...
htmlhelp_basename = '{{ FLOOR_PROJECT_NAME }} doc'
...
man_pages = [
    ('index', '{{ PROJECT_NAME }}', '{{ FLOOR_PROJECT_NAME }}\'s documentation',
     [author], 1)
]
...
epub_title = "{{ FLOOR_PROJECT_NAME }}"
epub_author = author
epub_publisher = "19pouces.net"
epub_copyright = '{{ year }}, %s' % author
