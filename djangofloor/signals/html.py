...
def render_to_client(window_info, template_name, context, selector, to=WINDOW, using=None):
    ...
    return scall(window_info, 'html.content', to=to, selector=selector, content=html_content)
...
def add(window_info, selector, html_content, to=WINDOW):
    ...
    return scall(window_info, 'html.add', to=to, selector=selector, content=html_content)
...
def add_attribute(window_info, selector, attr_name, attr_value, to=WINDOW):
    ...
    return scall(window_info, 'html.add_attribute', to=to, selector=selector, attr_name=attr_name,
                 attr_value=attr_value)


def add_class(window_info, selector, class_name, to=WINDOW):
    """Adds the specified class(es) to each of the set of matched elements."""
    return scall(window_info, 'html.add_class', to=to, selector=selector, class_name=class_name)


def append(window_info, selector, html_content, to=WINDOW):
    """Insert content, specified by the parameter, to the end of each element in the set of matched elements."""
    return scall(window_info, 'html.append', to=to, selector=selector, content=html_content)
...
def fade_out(window_info, selector, duration=400, to=WINDOW):
    ...
    return scall(window_info, 'html.fade_out', to=to, selector=selector, duration=duration)


def fade_in(window_info, selector, duration=400, to=WINDOW):
    """Display the matched elements by fading them to opaque."""
    return scall(window_info, 'html.fade_in', to=to, selector=selector, duration=duration)
...
def fade_to(window_info, selector, opacity, duration=400, to=WINDOW):
    ...
    """
    return scall(window_info, 'html.fade_to', to=to, selector=selector, duration=duration, opacity=opacity)
...
def fade_toggle(window_info, selector, duration=400, easing='swing', to=WINDOW):
    ...
    :param to: target of the signal
    """
    return scall(window_info, 'html.fade_toggle', to=to, selector=selector, duration=duration, easing=easing)
...
def hide(window_info, selector, duration=400, easing='swing', to=WINDOW):
    ...
    return scall(window_info, 'html.hide', to=to, selector=selector, duration=duration, easing=easing)


def prepend(window_info, selector, html_content, to=WINDOW):
    """Insert content, specified by the parameter, to the beginning of each element in the set of matched elements."""
    return scall(window_info, 'html.prepend', to=to, selector=selector, content=html_content)
...
def remove_class(window_info, selector, class_name, to=WINDOW):
    ...
    return scall(window_info, 'html.remove_class', to=to, selector=selector, class_name=class_name)


def remove_attr(window_info, selector, attr_name, to=WINDOW):
    """Remove an attribute from each element in the set of matched elements."""
    return scall(window_info, 'html.remove_attr', to=to, selector=selector, attr_name=attr_name)


def replace_with(window_info, selector, html_content, to=WINDOW):
    """Replace each element in the set of matched elements with the provided new content."""
    return scall(window_info, 'html.replace_with', to=to, selector=selector, content=html_content)


def show(window_info, selector, duration=400, easing='swing', to=WINDOW):
    """Display the matched elements."""
    return scall(window_info, 'html.show', to=to, selector=selector, duration=duration, easing=easing)


def text(window_info, selector, text_content, to=WINDOW):
    """Set the text contents of the matched elements."""
    return scall(window_info, 'html.text', to=to, selector=selector, content=text_content)


def toggle(window_info, selector, duration=400, easing='swing', to=WINDOW):
    """Display or hide the matched elements."""
    return scall(window_info, 'html.toggle', to=to, selector=selector, duration=duration, easing=easing)


def trigger(window_info, selector, event, to=WINDOW):
    """Execute all handlers and behaviors attached to the matched elements for the given event type."""
    return scall(window_info, 'html.replace_with', to=to, selector=selector, event=event)
