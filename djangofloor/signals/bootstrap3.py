...
INFO, DEFAULT, SUCCESS, DANGER, WARNING = 'info', 'default', 'success', 'danger', 'warning'
LEVELS = [DEFAULT, INFO, SUCCESS, DANGER, WARNING]


def notify(window_info, content, title=None, timeout=5000, style=NOTIFICATION, level=INFO, to=WINDOW):
...
def render_to_modal(window_info, template_name, context, width=None, to=WINDOW, using=None):
