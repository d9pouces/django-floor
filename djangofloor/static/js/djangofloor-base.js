...
*/
    ...
    $.df.connect('html.content', function (opts) { $(opts.selector).html(opts.content); });
/*"""
...
*/
    $.df.connect('html.add_attribute', function (opts) { $(opts.selector).attr(opts.attr_name, opts.attr_value); });
/*"""
...
*/
    $.df.connect('html.fade_out', function (opts) { $(opts.selector).fadeOut(opts.duration); });
/*"""
...
*/
    $.df.connect('html.fade_in', function (opts) { $(opts.selector).fadeIn(opts.duration); });
/*"""
...
*/
    $.df.connect('html.fade_to', function (opts) { $(opts.selector).fadeTo(opts.duration, opts.opacity); });
/*"""
...
*/
    $.df.connect('html.fade_toggle', function (opts) { $(opts.selector).fadeToggle(opts.duration, opts.easing); });
/*"""
...
*/
    $.df.connect('html.focus', function (opts) { $(opts.selector).focus(); });
/*"""
...
*/
    $.df.connect('html.hide', function (opts) { $(opts.selector).hide({duration: opts.duration, easing: opts.easing}); });
/*"""
...
*/
    $.df.connect('html.remove_attr', function (opts) { $(opts.selector).removeAttr(opts.attr_name); });
/*"""
...
*/
    $.df.connect('html.replace_with', function (opts) { $(opts.selector).replaceWith(opts.content); });
/*"""
...
*/
    $.df.connect('html.show', function (opts) { $(opts.selector).show({duration: opts.duration, easing: opts.easing}); });
/*"""
...
*/
    $.df.connect('html.toggle', function (opts) { $(opts.selector).toggle({duration: opts.duration, easing: opts.easing}); });
/*"""
...
*/
    $.df.connect('html.val', function (opts) { $(opts.selector).val(opts.value); });
/*"""
