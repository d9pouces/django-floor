...
if settings.DF_SYSTEM_CHECKS:
    ...
    urlpatterns += [url(r'^monitoring/exception/', monitoring.raise_exception, name='raise_exception')]
    urlpatterns += [url(r'^monitoring/log/', monitoring.generate_log, name='generate_log')]
