...
BOOTSTRAP3 = {'theme_url': None, 'javascript_url': None, 'jquery_url': '/static/js/jquery.min.js', 'horizontal_label_class': 'col-md-4', 'css_url': None, 'horizontal_field_class': 'col-md-8',
...
CELERY_LOG_FILE = './django_data/log/celerybeat.log'
CELERY_PID_FILE = './django_data/run/djangofloor_celery.pid'
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.sqlite3', 'ATOMIC_REQUESTS': False, 'TIME_ZONE': 'UTC', 'CONN_MAX_AGE': 0, 'PASSWORD': '',
                         'TEST': {'COLLATION': None, 'MIRROR': None, 'CHARSET': None, 'NAME': None}, 'NAME': './django_data/data/database.sqlite3',
                         'HOST': '', 'AUTOCOMMIT': True, 'OPTIONS': {}, 'USER': '', 'PORT': ''}}
...
DJANGOFLOOR_CONFIG_PATH = '/Users/flanker/.virtualenvs/djangofloor/etc/djangofloor/settings.ini'
...
GUNICORN_ACCESS_LOG_FILE = './django_data/log/gunicorn_access.log'
GUNICORN_ERROR_LOG_FILE = './django_data/log/gunicorn_error.log'
GUNICORN_LOG_LEVEL = 'info'
GUNICORN_PID_FILE = './django_data/run/djangofloor_gunicorn.pid'
...
USER_SETTINGS_PATH = '/Users/flanker/.virtualenvs/djangofloor/etc/djangofloor/settings.py'
USE_CELERY = False
USE_I18N = True
USE_L10N = True
USE_SCSS = True
