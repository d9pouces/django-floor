...
BOOTSTRAP3 = {'css_url': None, 'javascript_url': None, 'theme_url': None, 'base_url': '/static/bootstrap3/', 'horizontal_field_class': 'col-md-8', 'horizontal_label_class': 'col-md-4', 'jquery_url': '/static/js/jquery.min.js'}
...
DATABASES = {'default': {'OPTIONS': {}, 'AUTOCOMMIT': True, 'CONN_MAX_AGE': 0, 'ATOMIC_REQUESTS': False, 'TIME_ZONE': 'UTC', 'NAME': '/Users/flanker/Developer/Github/DjangoFloor/django_data/data/database.sqlite3', 'USER': '', 'PASSWORD': '', 'TEST': {'NAME': None, 'CHARSET': None, 'COLLATION': None, 'MIRROR': None}, 'ENGINE': 'django.db.backends.sqlite3', 'PORT': '', 'HOST': ''}}
...
LOGGING = {'filters': {'require_debug_false': {'()': 'django.utils.log.RequireDebugFalse'}}, 'version': 1, 'handlers': {'mail_admins': {'level': 'ERROR', 'filters': ['require_debug_false'], 'min_interval': 600, 'class': 'djangofloor.log.FloorAdminEmailHandler'}, 'stream': {'level': 'WARNING', 'filters': ['require_debug_false'], 'class': 'logging.StreamHandler'}}, 'disable_existing_loggers': False, 'loggers': {'django.request': {'propagate': True, 'handlers': ['mail_admins', 'stream'], 'level': 'ERROR'}}}
LOGIN_REDIRECT_URL = '/'
