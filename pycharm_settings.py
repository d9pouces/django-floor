...
DATABASES = {'default': {'OPTIONS': {}, 'AUTOCOMMIT': True, 'CONN_MAX_AGE': 0, 'ATOMIC_REQUESTS': False, 'TIME_ZONE': 'UTC', 'NAME': './django_data/data/database.sqlite3', 'USER': '', 'PASSWORD': '', 'TEST': {'NAME': None, 'CHARSET': None, 'COLLATION': None, 'MIRROR': None}, 'ENGINE': 'django.db.backends.sqlite3', 'PORT': '', 'HOST': ''}}
...
PIPELINE_JS = {'ie9': {'source_filenames': ['js/html5shiv.js', 'js/respond.min.js'], 'output_filename': 'js/ie9.js'}, 'default': {'source_filenames': ['js/jquery.min.js', 'bootstrap3/js/bootstrap.min.js', 'js/djangofloor.js', 'js/ws4redis.js', 'js/jquery.fileupload.js', 'js/jquery.iframe-transport.js', 'js/jquery.ui.widget.js', ], 'output_filename': 'js/default.js'}}
